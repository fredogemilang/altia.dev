...
export function HeroLamp({ badge, children, className }: HeroLampProps) {
  return (
    ...
    >
      ...
      {/* ── Single Unified Symmetrical Vermilion Spotlight (Originates Below Badge) ── */}
      <div className="relative flex flex-col items-center w-full">
        <div className="absolute top-0 left-0 right-0 h-[480px] sm:h-[560px] flex w-full items-start justify-center isolate pointer-events-none z-0 overflow-hidden">
          ...
          {/* Horizon Laser Slit Bar (Below the badge, above headline) */}
          <motion.div
