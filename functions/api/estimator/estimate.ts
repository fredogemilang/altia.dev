import { handleEstimateCalculation, type EstimatorAnswers } from '../../../src/lib/api-handlers';
...
export async function onRequestPost(context: EventContext<any, string, any>) {
  try {
    const body = (await context.request.json().catch(() => ({}))) as { answers?: EstimatorAnswers };
